...
const validationSchema = Yup.object({
  topic: Yup.string()
    .required("Please enter the topic field")
    .matches(/^[aA-zZ\s]+$/, "Only alphabets are allowed for this field ")
    .max(25, "Maximum character limit (25) reached !"),
  description: Yup.string()
    .required("Please enter the description field")
    .matches(/^[aA-zZ\s]+$/, "Only alphabets are allowed for this field ")
    .max(25, "Maximum character limit (50) reached !"),
  ...
  cardno: Yup.number()
    .typeError("Please enter only numbers in the feild")
    .positive("Please enter only positive integer numbers")
    .min(100000000000, "Card Number must be 12 digits")
    .max(999999999999, "Card Number must be 12 digits")
        ...
        <Formik
          ...
          onSubmit={async (values) => {
            ...
            await axios
              ...
              .catch((err) => {
                Notification("success", `Payment is successfully added!`);
              });
          }}
        >
